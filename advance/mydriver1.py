...
def web_driver_to_login_at_pythonanywhere():

   print('\n Web Driver Started Now')
   ...
   try:
      driver.find_element(By.XPATH,'/html/body/div[1]/div[2]/div/div/form/p[1]/input').send_keys('yadav222')
   except:
   ...
   try:
      ...
      print('\n We Are logged in successfull into python anywhere using web driver')
...
web_driver_to_login_at_pythonanywhere()
